...
public class JPADatabaseApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		logger.info("Inserting = {}", personJpaRepository.insert(new Person("Bolek", "Warszawa", new Date())));
		logger.info("Updating 10005: {}",personJpaRepository.insert(new Person (10005,"Seweryn", "Tokio", new Date())));
